 ...
 */
public record StartedVote(String name, Text displayName, int startTick, int secondsToLive, boolean announceEnd, List<VoteOption> options, Map<UUID, Integer> votes) {
