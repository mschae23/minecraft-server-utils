...
public record MiscConfig(DeathCoordsConfig deathCoords, BroadcastEntityDeathConfig broadcastEntityDeath, EnableGamemodeSwitcherConfig enableGamemodeSwitcher, ItemFrameConfig itemFrame, GameRulesConfig gameRules) {
    public static final Codec<MiscConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        GameRulesConfig.CODEC.fieldOf("game_rules").forGetter(MiscConfig::gameRules)
    ).apply(instance, instance.stable(MiscConfig::new)));

    public static final MiscConfig DEFAULT = new MiscConfig(DeathCoordsConfig.DEFAULT, BroadcastEntityDeathConfig.DEFAULT, EnableGamemodeSwitcherConfig.DEFAULT, ItemFrameConfig.DEFAULT, GameRulesConfig.DEFAULT);
}
